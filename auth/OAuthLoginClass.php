...
class OAuthLoginClass {
	...
	public static function ConnectOAuth($type) {
		...
		switch ($type) {
			case 'qq':
				require_once 'OAuthQqClass.php';
				$oauth = new OAuthQqClass();
				break;
			case 'wechat':
				require_once 'OAuthWechatClass.php';
				$oauth = new OAuthWechatClass();
				break;
			case 'weibo':
				require_once 'OAuthWeiboClass.php';
				$oauth = new OAuthWeiboClass();
				break;
		}
